...
<!--script src="jsmenu/jquery.js"></script-->
...
<!--script type="text/javascript" src="src/jquery.scrollbars.js"></script--> 
...
?>
 ...
 <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"  height="85" id="FlashID" title="flash" style="width:100% !important">
   ...
   <!--[if !IE]>-->
   <object type="application/x-shockwave-flash" data="img/1.swf" width="352" height="85">
     <!--<![endif]-->
     <param name="quality" value="high">
     <param name="wmode" value="opaque">
     <param name="swfversion" value="6.0.65.0">
